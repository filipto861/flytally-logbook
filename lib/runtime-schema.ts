...
async function applyRuntimeSchema(){
  ...
  await Promise.all([ensureV132Schema(),ensureV1353Schema(),ensureV144Schema(),ensureV145Schema(),ensureV148Schema(),ensureV151Schema(),ensureV159Schema(),ensureV162Schema(),ensureV163Schema(),ensureV164Schema()]);
}
