export const FLIGHT_PURPOSES=[
  ...
  {code:"BPL_BFCL160_TRAINING",label:"BPL · BFCL.160 recency training",task:"BFCL.160 training flight"},
] as const;
...
export function primaryFlightPurposeCode(value:unknown):FlightPurposeCode|""{
  ...
  for(const code of ["LAPL_FCL140A_REFRESHER","LAPL_H_FCL140H_REFRESHER","SEP_TMG_FCL740A_REFRESHER","SPL_SFCL160_TRAINING","BPL_BFCL160_TRAINING","AIRCRAFT_DIFFERENCES","AIRCRAFT_FAMILIARISATION"] as const)if(selected.has(code))return code;
  return "";
}
