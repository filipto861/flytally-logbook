...
import { dashboardPresetLayout,dashboardWidgetDefinition,defaultDashboardLayout,type DashboardLayoutItem,type DashboardPresetId,type DashboardWidgetSize } from "@/lib/dashboard-widgets";
...
const groupLabels={primary:"Flying time",quick:"Overview",analysis:"Analysis"} as const;
