...
export function FlightPurposePicker({value=""}:{value?:unknown}){
  ...
  return <fieldset className="flight-purpose-picker wide">
    ...
    <small className="field-note">Choose any combination that applies. Leave all clear for a normal flight; Task / exercise remains free text. The structured LAPL purpose means LAPL recency does not depend on free-text wording.</small>
  </fieldset>;
}
