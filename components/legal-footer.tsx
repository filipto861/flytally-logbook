...
export function LegalFooter({ compact=false }: { compact?: boolean }) {
  return (
    <nav aria-label="Legal" style={{display:"flex",flexWrap:"wrap",justifyContent:"center",gap:compact?"6px 10px":"8px 14px",fontSize:compact?".67rem":".72rem",color:"var(--muted)",opacity:.72}}>
