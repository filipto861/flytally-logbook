...
export function AppShell({ children,role,actionCount=0,attentionCount=0,appearance="system" }: { children: React.ReactNode;role:"admin"|"user";actionCount?:number;attentionCount?:number;appearance?:AppearancePreference }) {
  return (
