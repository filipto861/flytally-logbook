...
function AircraftFields({aircraft}:{aircraft?:Row}){
  ...
  return <div className="aircraft-form-grid guided-aircraft-fields">
    ...
    <label>Make<input name="aircraft_make" defaultValue={t(aircraft?.aircraft_make)} placeholder="Tecnam" required={logbook==="EASA"}/><small>{logbook==="EASA"?"Required for the EASA aircraft identity.":"Manufacturer, when known."}</small></label>
