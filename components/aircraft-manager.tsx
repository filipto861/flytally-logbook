...
function AircraftFields({aircraft}:{aircraft?:Row}){
  ...
  return <div className="aircraft-form-grid guided-aircraft-fields">
    ...
    <label><span>Registration <span className="field-hint" aria-hidden="true">Required</span></span><input name="registration" defaultValue={t(aircraft?.registration)} placeholder="OK-ABC" required readOnly={editing}/><small>The registration used in flight entries.</small></label>
