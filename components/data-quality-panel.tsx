...
export function DataQualityPanel({issues,airportStats}:{issues:Row[];airportStats:Row}){
  ...
  return <details className="panel quality-panel" open><summary><span>Data quality</span><small>{issues.length?`${problems} problems · ${warnings} warnings`:"No issues found"}</small></summary>
