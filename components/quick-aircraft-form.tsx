...
export function QuickAircraftForm({action,onSaved}:{action:SaveAction;onSaved?:()=>void}){
  ...
  return <form action={submit} className="aircraft-dialog-form quick-aircraft-form">
    ...
    <label>Registration <span className="field-hint" aria-hidden="true">Required</span><input name="registration" placeholder="OK-ABC" autoCapitalize="characters" required autoFocus/><small>The registration shown in your logbook.</small></label>
