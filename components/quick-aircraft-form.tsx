...
export function QuickAircraftForm({action,onSaved}:{action:SaveAction;onSaved?:()=>void}){
  ...
  return <form action={submit} className="aircraft-dialog-form quick-aircraft-form">
    ...
    <label><span>Registration <span className="field-hint" aria-hidden="true">Required</span></span><input name="registration" placeholder="OK-ABC" autoCapitalize="characters" required autoFocus/><small>The registration shown in your logbook.</small></label>
