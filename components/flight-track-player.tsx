...
export function FlightTrackPlayer({tracks}:{tracks:MapTrack[]}) {
  ...
  return <section className="track-player-suite">
    <div ref={target} className="track-map responsive-map player-responsive-map" style={{"--map-height":"500px"} as React.CSSProperties} aria-label="Synchronizovaná mapa GPS tracku"/>
