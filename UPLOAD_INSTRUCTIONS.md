...
### v0.62.2 note
`sitecustomize.py` is no longer part of the application from v0.70 onward. Remove any old copy from the repository if one is still present; the app no longer uses a Python startup hook.
...
7. Doporučený commit: `v0.70 - Pilot Currency & Recency`.
