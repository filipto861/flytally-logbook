...
test("v2.3 release metadata stays aligned",()=>{
  ...
  assert.equal(lock.version,"2.3.0");
  ...
  assert.match(roadmap,/## Post-v2\.3 roadmap/);
  assert.match(roadmap,/### v2\.4 — Flight Entry & Review 2\.0/);
});
