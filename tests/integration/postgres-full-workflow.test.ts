...
const flightColumns=`
  id BIGINT PRIMARY KEY,user_id BIGINT NOT NULL,date DATE,evidence TEXT NOT NULL DEFAULT '',registration TEXT NOT NULL DEFAULT '',aircraft_make TEXT NOT NULL DEFAULT '',aircraft_model TEXT NOT NULL DEFAULT '',aircraft_variant TEXT NOT NULL DEFAULT '',aircraft_type TEXT NOT NULL DEFAULT '',aircraft_class TEXT NOT NULL DEFAULT '',regulatory_category TEXT NOT NULL DEFAULT 'AEROPLANE',balloon_class TEXT NOT NULL DEFAULT '',balloon_group TEXT NOT NULL DEFAULT '',balloon_operation TEXT NOT NULL DEFAULT '',launch_method TEXT NOT NULL DEFAULT '',launches INTEGER NOT NULL DEFAULT 0,departure TEXT NOT NULL DEFAULT '',arrival TEXT NOT NULL DEFAULT '',off_block TEXT NOT NULL DEFAULT '',takeoff TEXT NOT NULL DEFAULT '',landing TEXT NOT NULL DEFAULT '',on_block TEXT NOT NULL DEFAULT '',starts INTEGER NOT NULL DEFAULT 0,operation_type TEXT NOT NULL DEFAULT 'SP',engine_type TEXT NOT NULL DEFAULT 'SE',operator_name TEXT NOT NULL DEFAULT '',flight_number TEXT NOT NULL DEFAULT '',operation_context TEXT NOT NULL DEFAULT '',landings_day INTEGER NOT NULL DEFAULT 0,landings_night INTEGER NOT NULL DEFAULT 0,movement_evidence_recorded BOOLEAN NOT NULL DEFAULT FALSE,takeoffs_day INTEGER NOT NULL DEFAULT 0,takeoffs_night INTEGER NOT NULL DEFAULT 0,approaches_day INTEGER NOT NULL DEFAULT 0,approaches_night INTEGER NOT NULL DEFAULT 0,night_minutes INTEGER NOT NULL DEFAULT 0,ifr_minutes INTEGER NOT NULL DEFAULT 0,pic_minutes INTEGER NOT NULL DEFAULT 0,copilot_minutes INTEGER NOT NULL DEFAULT 0,dual_minutes INTEGER NOT NULL DEFAULT 0,instructor_minutes INTEGER NOT NULL DEFAULT 0,commander TEXT NOT NULL DEFAULT '',instructor TEXT NOT NULL DEFAULT '',role TEXT NOT NULL DEFAULT '',task TEXT NOT NULL DEFAULT '',note TEXT NOT NULL DEFAULT '',purpose_code TEXT NOT NULL DEFAULT '',verification_name TEXT NOT NULL DEFAULT '',verification_reference TEXT NOT NULL DEFAULT '',certified_at TIMESTAMPTZ,certified_by_user_id BIGINT,certification_hash TEXT NOT NULL DEFAULT '',certification_version INTEGER NOT NULL DEFAULT 8,locked_at TIMESTAMPTZ,locked_by_user_id BIGINT,record_revision INTEGER NOT NULL DEFAULT 1,correction_reason TEXT NOT NULL DEFAULT '',correction_opened_at TIMESTAMPTZ,correction_opened_by_user_id BIGINT
`;
...
test("AC-01/03/04/05/06/26 full certified workflow stays consistent across current and historical projections",{skip:!enabled},()=>{
  ...
  const draft={id:401,user_id:41,date:"2026-08-28",evidence:"EASA",registration:"OK-WF1",aircraft_make:"Bristell",aircraft_model:"B23",aircraft_variant:"",aircraft_type:"B23",aircraft_class:"SEP",regulatory_category:"AEROPLANE",balloon_class:"",balloon_group:"",balloon_operation:"",launch_method:"",launches:0,departure:"LKPR",arrival:"LKBE",off_block:"08:00",takeoff:"08:05",landing:"09:00",on_block:"09:05",starts:1,operation_type:"SP",engine_type:"SE",operator_name:"Workflow Training",flight_number:"WF401",operation_context:"TRAINING",landings_day:1,landings_night:0,movement_evidence_recorded:false,takeoffs_day:0,takeoffs_night:0,approaches_day:0,approaches_night:0,night_minutes:0,ifr_minutes:0,pic_minutes:0,copilot_minutes:0,dual_minutes:65,instructor_minutes:0,commander:"Test Instructor",instructor:"Test Instructor",role:"DUAL",task:"Training exercise",note:"",purpose_code:"",verification_name:"",verification_reference:"",certification_version:8,record_revision:1,correction_reason:""};
  ...
  assert.equal(String(current.operator_name),"Workflow Training");
  assert.equal(String(current.flight_number),"WF401");
  assert.equal(String(current.operation_context),"TRAINING");
