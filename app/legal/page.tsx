...
export default function LegalIndexPage(){
  ...
  return <main className="page-shell" style={{maxWidth:"900px",margin:"0 auto"}}>
    ...
    <section className="panel" style={{display:"grid",gap:"14px"}}>
      ...
      <article style={{paddingBottom:"14px",borderBottom:"1px solid var(--border)"}}><h2 style={{marginBottom:"6px"}}><Link href="/legal/release-status">Release status</Link></h2><p className="muted" style={{margin:0}}>Public high-level status of the final commercial-release gate without exposing the internal validation ledger.</p></article>
    </section>
