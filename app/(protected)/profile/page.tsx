      ...
      <main className="u33-settings-workspace">
        ...
        <form action={saveAccountSettings} className="account-settings-form u33-general-form">
          <div className="profile-grid">
            <section className="panel"><p className="eyebrow">PERSONAL</p><h2>Pilot details</h2><div className="stack-form"><label>Name <span className="field-hint" aria-hidden="true">Required</span><input name="display_name" defaultValue={t(user.display_name)} required/></label><label>Account email<input type="email" value={t(user.email)} readOnly/><small>Your sign-in identity. Email changes require verification.</small></label></div></section>
