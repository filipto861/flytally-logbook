...
import { ProfessionalExperiencePanel } from "@/components/professional-experience-panel";
...
export default async function CredentialsPage(props:PageProps){
  ...
  if(!rawView||rawView==="overview")return <><AdaptivePilotOverview/><ProfessionalExperiencePanel/></>;
