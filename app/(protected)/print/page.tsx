...
import { isAuxiliaryLogbookRole,logbookPrintScopeLabel,matchesLogbookPrintScope,normalizeLogbookPrintScope,parsePilotPreferences,pilotInCommandName,printIdentity } from "@/lib/logbook-print";
...
function Header(){return <thead>
  ...
  <tr><th>PLACE</th><th>TIME<br/><small>UTC</small></th><th>PLACE</th><th>TIME<br/><small>UTC</small></th><th>MAKE, MODEL, VARIANT</th><th>REGISTRATION</th><th>SE</th><th>ME</th><th>DAY</th><th>NIGHT</th><th>NIGHT</th><th>IFR</th><th>PIC</th><th>CO-PILOT</th><th>DUAL</th><th>FI/FE</th><th>DATE<br/><small>dd/mm/yy</small></th><th>TYPE</th><th>TOTAL TIME<br/>OF SESSION</th></tr>
</thead>}
