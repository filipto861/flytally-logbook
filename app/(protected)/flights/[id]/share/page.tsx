...
export default async function ShareFlightPage({params,searchParams}:{params:Promise<{id:string}>;searchParams:Promise<{token?:string}>}){
  ...
  return <main className="page-shell">
    ...
    <section className="panel"><p className="eyebrow">VIEW-ONLY LINK</p><h2>Public flight page</h2>
      ...
      <div className="share-safety-note"><strong>Before publishing</strong><p className="muted">Anyone with the secret URL can view the route summary, departure/arrival, aircraft type and flight statistics. The options below additionally control whether registration, date and the GPS route/distance are public. Public pages are marked noindex and can be revoked at any time.</p></div>
